...
class Api {
  ...
  static Future getTrailingReturns(
    ...
    String url =
        ...
        "&category=$category: $subCategory&client_name=$client_name&period=$period&type=Open&maxno=1000&mode=Growth&amc=$amc";
  ...
  static Future getBroadCategoryList({required String client_name}) async {
    String url =
        "${ApiConfig.apiUrl}/mfresearch/getAllBroadCategory?key=${ApiConfig.apiKey}&client_name=$client_name";
