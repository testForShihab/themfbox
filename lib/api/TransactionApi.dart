...
class TransactionApi {
  ...
  static Future getBSESwitchExistingSchemes({
      required int user_id,
      required String client_name,
      required String amc_name,
      required String scheme_amfi_short_name,
    })async{
    String url ="${ApiConfig.apiUrl}/transact/getBSESwitchExistingSchemes?key=${ApiConfig.apiKey}&user_id=$user_id&client_name=$client_name&amc_name=$amc_name&scheme_amfi_short_name=$scheme_amfi_short_name";
    print("getBSESwitchExistingSchemes url = $url");
    http.Response response = await http.post(Uri.parse(url));
    Map data = jsonDecode(response.body);
    print("getBSESwitchExistingSchemes response = $data");
    return data;

}

  static Future getSwitchSchemeDividendOptions({
    required int user_id,
    required String client_name,
    required String scheme_name,
    required String bse_nse_mfu_flag,
    ...
    String url = "${ApiConfig.apiUrl}/transact/getSwitchSchemeDividendOptions?key=${ApiConfig.apiKey}&user_id=$user_id&client_name=$client_name&scheme_name=$scheme_name&bse_nse_mfu_flag=$bse_nse_mfu_flag&option=$option";
    print("getSwitchSchemeDividendOptions url = $url");
    http.Response response = await http.post(Uri.parse(url));
    Map data = jsonDecode(response.body);
    print("getSwitchSchemeDividendOptions response = $data");
    return data;
  }
  ...
  static Future getSipAmc({
    ...
    String url = "${ApiConfig.apiUrl}/transact/getSipAmc?key=${ApiConfig.apiKey}&bse_nse_mfu_flag=$bse_nse_mfu_flag&client_name=$client_name";
