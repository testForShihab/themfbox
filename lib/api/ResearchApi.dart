...
class ResearchApi {
  ...
  static Future getSchemeInfo({
    required int user_id,
    required String client_name,
    required String scheme,
  }) async {
    String url =
        "${ApiConfig.apiUrl}/mfresearch/getSchemeInfo?key=${ApiConfig.apiKey}&user_id=$user_id&client_name=$client_name&scheme=$scheme";
  ...
  static Future getLumpsumReturnsTableCalc({
    ...
    String url =
        "${ApiConfig.apiUrl}/mfresearch/getLumpsumReturnsTableCalc?key=${ApiConfig.apiKey}&user_id=$user_id&client_name=$client_name&scheme=$scheme&amount=$amount&period=$period";
  ...
  static Future getPortfolioAnalysis({
    ...
    String url =
        "${ApiConfig.apiUrl}/mfresearch/getPortfolioAnalysis?key=${ApiConfig.apiKey}&user_id=$user_id&client_name=$client_name&scheme=$scheme";
  ...
  static Future getNavMovementGraph({
    ...
    String url =
        ...
        "user_id=$user_id&client_name=$client_name&scheme=$scheme&period=$period";
  ...
  static Future getLumpsumReturnsPeriodAndAmount({
    ...
    String url =
        ...
        "user_id=$user_id&client_name=$client_name&scheme_name=$scheme_name";
