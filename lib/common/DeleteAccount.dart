...
class _DeleteAccountState extends State<DeleteAccount> {
  ...
  Future deleteUser() async {
    print("user_id: $userId, client_name: $clientName");
    Map data =
            ...
            children: [
              ...
              CalculateButton(
                  onPress: () async {
                    Get.back();
                    await deleteUser();
                    EasyLoading.showInfo("Your request has been received and is currently being processed. Your advisor will contact you, and once the process is complete, your account will be deleted.",);
                    reason = "";
                    Get.back();
                  },
                  text: "Confirm")
