...
class RetirementPlannerOutput extends StatefulWidget {
  ...
  final int targetAmount, currentAge, retirementAge, endAge;
  final num currentInvestment, monthlyExpense, energyCorpus, inflation;
  final Map result;
...
class _RetirementPlannerOutputState extends State<RetirementPlannerOutput> {
  ...
  late num currentMonthExpense, futureValue, endAge, monthlyExpense;
  late Map result;
  ...
  void initState() {
    // implement initState
    super.initState();
    currentMonthExpense = widget.monthlyExpense;
    result = widget.result;

    projectAmt = result['scenario1_swp_amount'] ?? 0;
              ...
              GestureDetector(
                  onTap: () {
                    String url =
                        ...
                        "&balance_required=${widget.targetAmount}"
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "$rupee ${Utils.formatNumber(currentMonthExpense)}",
                            style: AppFonts.f50014Black,
                          ),
                        ],
                      ),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "Projected Monthly Expense at Retirement",
                                  style: AppFonts.f50014Black,
                                ),
                                Text(
                                  "Assuming ${widget.inflation}% Inflation",
                          ...
                          Expanded(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                "$rupee ${Utils.formatNumber(projectAmt)}",
                                style: AppFonts.f50014Black,
                              ),
                            ),
                          ),
