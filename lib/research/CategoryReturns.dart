...
class _CategoryReturnsState extends State<CategoryReturns> {
  ...
  Map periodMap = {0: "1W", 1: "1M", 2: "3M", 3: "6M", 4: "YTD", 5: "1Y", 6: "3Y", 7: "5Y", 8: "10Y"};
  String period = "1W";
        ...
        child: Column(
          ...
          children: [
            ...
            isLoading
                ...
                : categoryReturns.isEmpty && searchKey.isNotEmpty
                ? NoData()
                :ListView.builder(
  ...
  Widget fundCard(Color color, Map data) {
    ...
    num median_returns = data['median_rolling_returns'];
    return Container(
      padding: EdgeInsets.all(16),
      ...
      child: Column(
        children: [
          ...
          rpRow(
              lhead: "Avg Rtn", lSubHead: "$average_returns %", /*lvalueStyle: AppFonts.f50014Theme.copyWith(
                  color: (average_returns > 0)
                  ? Config.appTheme.defaultProfit
                      : Config.appTheme.defaultLoss),*/
              rhead: "Max Rtn", rSubHead: "$max_returns %",/*rvalueStyle: AppFonts.f50014Theme.copyWith(
              color: (max_returns > 0)
                  ? Config.appTheme.defaultProfit
                  : Config.appTheme.defaultLoss),*/
              chead: "Min Rtn", cSubHead: "$min_returns %",/*cvalueStyle: AppFonts.f50014Theme.copyWith(
              color: (min_returns > 0)
                  ? Config.appTheme.defaultProfit
                  : Config.appTheme.defaultLoss),*/
              lasthead: 'Median Rtn', lastSubHead: '$median_returns %',/*lastvalueStyle: AppFonts.f50014Theme.copyWith(
              color: (median_returns > 0)
                  ? Config.appTheme.defaultProfit
                  : Config.appTheme.defaultLoss),*/),
        ],
      ),
  ...
  Widget rpRow({
    ...
    required String lasthead,
    required String lastSubHead,
    final TextStyle? lvalueStyle,
    final TextStyle? rvalueStyle,
    final TextStyle? cvalueStyle,
    final TextStyle? lastvalueStyle,
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  setState(() {
                                    ...
                                    print("category Returns length ${categoryReturns.length}");
                                  });
                                  categoryReturns = [];
                                  await getCategoryReturns();
                                  Get.back();
