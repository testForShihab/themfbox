                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: appBarColumn(
                              "Lumpsum Amount",
                              getFirst13(NumberFormat('#,##,##0').format(int.parse(selectedAmount))),
                              Icon(Icons.keyboard_arrow_down,
                                  color: Config.appTheme.themeColor)),
                        ),
                        GestureDetector(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  advRow(
                    lhead: "AUM (Cr)",
                    lSubHead: "$rupee ${Utils.formatNumber(aum / 10)}",
                    rhead: "TER",
                    rSubHead: "${fund.ter} %",
                    chead: "Invested Amt",
                    cSubHead:  NumberFormat('#,##,##0').format(int.parse(selectedAmount)),
                  ),
                  SizedBox(
                    height: 10,
                  ),
                advRow(
                    lhead: "Current Value",
                    lSubHead: Utils.formatNumber(currValue.round()),
                    rhead: "Annualized \n Return (%)",
