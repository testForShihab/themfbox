          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: ColumnText(
                    title: "${nfoFundOffering.schemeAmfi}",
                    value:
                        "Equity • Sectoral • High Risk", //"${category.replaceAll(":", " •")} • High Risk",
              ...
              children: [
                Row(
                  ...
                  children: [
                    ColumnText(
                      title: "Min Lumpsum",
                      value: "$rupee $lumpsumMinimumAmount",
                      valueStyle: AppFonts.f50014Black,
                    ),
                    ColumnText(
                      title: "Min SIP",
                      value: "$rupee $minSipAmount",
                    ...
                    ColumnText(
                      ...
                      valueStyle: AppFonts.f50014Black
                          .copyWith(color: Color(0xff3CB66D)),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    SizedBox(
                        width: 120,
                        child: infoColumn(
                            "Benchmark", "${nfoFundOffering.benchmark}")),
                  ],
                ),
              ],
            ),
