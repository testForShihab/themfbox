...
import '../../pojo/lumpsum/AllLumpsumFundsPojo.dart';
...
class _AnnualReturnsState extends State<AnnualReturns> {
  ...
  String selectedSubCategory = "Equity: Multi Cap";
  ...
  getYear() {
    ...
    print("str year1 = $str_year1");
    print("str year2 = $str_year2");
    print("str year3 = $str_year3");
    print("str year4 = $str_year4");
    print("str year5 = $str_year5");
  }
  ...
  Widget blackBox() {
    ...
    // PerformanceReturnsPojo? firstLumpsumPojo =
    //     performancePojoList.isNotEmpty ? performancePojoList.first : null;
        ...
        itemBuilder: (context, index) {
          ...
          return Row(
            ...
            children: [
              ...
              Text("$dataValue %",
                  style: AppFonts.f50014Black
                      .copyWith(color: (dataValue > 0)? Config.appTheme.themeProfit : Config.appTheme.themeLoss)),
            ],
          );
        },
      ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ColumnText(
                          title: "AUM (Cr)",
                          value: "$rupee ${Utils.formatNumber((aum))}"),
                      ColumnText(title: "TER (%)", value: "${fund.ter}",alignment: CrossAxisAlignment.center,),
                      // ColumnText(
                      //   title: "Doubled In",
                      //   value: fund.doubleIn ?? '',
