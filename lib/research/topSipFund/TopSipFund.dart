...
class _TopSipFundsState extends State<TopSipFunds> {
  ...
  String selectedLumpsumAmount = "10000";
  String selectedPeriod = "5";
  String selectedInvestedAmount = "600000";
  ...
  Future getSipFunds() async {
    if (performanceList.isNotEmpty) return 0;

    EasyLoading.show();
    Map data = await Api.getSipFund(
      ...
      builder: (context) {
        return StatefulBuilder(builder: (_, bottomState) {
          return Container(
            ...
            child: Column(
              children: [
                BottomSheetTitle(title: "Explore Funds Category Wise"),
