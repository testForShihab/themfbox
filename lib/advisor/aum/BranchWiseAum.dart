...
class BranchWiseAum extends StatefulWidget {
  const BranchWiseAum({super.key});

  @override
  State<BranchWiseAum> createState() => _BranchWiseAumState();
}

class _BranchWiseAumState extends State<BranchWiseAum> {
        ...
        child: SingleChildScrollView(
            ...
            child: (isLoading)
                ...
                : investorList.isEmpty
                    ? NoData(text: "No Branch Available")
                    : ListView.separated(
                        shrinkWrap: true,
