...
class ActiveSwp extends StatefulWidget {
  const ActiveSwp({
    super.key,
  ...
  @override
  State<ActiveSwp> createState() => _ActiveSwpState();
}

class _ActiveSwpState extends State<ActiveSwp> {
        ...
        child: (isLoading)
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  ActiveSwpPojo sip = ActiveSwpPojo.fromJson(data);
                            ...
                            Row(
                              ...
                              children: [
                                ColumnText(
                                  title:
                                  "Start Date",
                                  value: "${swp.startDate}",//"{sip.autoDebitDate} {sip.frequency}",
                                  alignment: CrossAxisAlignment.start,
                                  titleStyle: AppFonts.f50014Black,
                                  valueStyle: AppFonts.f40013,
                                ),
                                ColumnText(
                                  title:
                                  "End Date",
                                  value: "${swp.endDate}",//"{sip.autoDebitDate} {sip.frequency}",
                                  alignment: CrossAxisAlignment.end,
                                  titleStyle: AppFonts.f50014Black,
                                  valueStyle: AppFonts.f40013,
                                ),
