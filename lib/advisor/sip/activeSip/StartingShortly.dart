...
class StartingShortly extends StatefulWidget {
  const StartingShortly(
      {super.key,
  ...
  @override
  State<StartingShortly> createState() => _StartingShortlyState();
}

class _StartingShortlyState extends State<StartingShortly> {
  ...
  Future getInitialInvestors() async {
    ...
    Map data = await AdminApi.getSipStartingShortlyDetails(
      user_id: user_id,
        ...
        child: (isLoading)
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  StartingShortlyPojo sip = StartingShortlyPojo.fromJson(data);
  ...
  Widget sipTile(StartingShortlyPojo sip) {
  ...
  sipBottomSheet(StartingShortlyPojo sip) {
...
class StartingShortlyPojo {
  ...
  StartingShortlyPojo.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    pan = json['pan'];
    email = json['email'];
    mobile = json['mobile'];
