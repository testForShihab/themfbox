...
class BounceSip extends StatefulWidget {
  const BounceSip({
    super.key,
  ...
  @override
  State<BounceSip> createState() => _BounceSipState();
}

class _BounceSipState extends State<BounceSip> {
  ...
  Future getInitialInvestors() async {
    ...
    Map data = await AdminApi.getSipBounceReoprtDetails(
      user_id: user_id,
        ...
        child: (isLoading)
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  BounceSipPojo sip = BounceSipPojo.fromJson(data);
  ...
  Widget sipTile(BounceSipPojo sip) {
    String name = sip.schemeAmfiShortName ?? "";
    if (name.isEmpty) name = sip.scheme ?? "";
  ...
  sipBottomSheet(BounceSipPojo sip) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            rpRow(
                              lhead: "Current Cost",
                              lSubHead:
                                  "$rupee ${Utils.formatNumber(sip.investedCost, isAmount: true)}",
                              rhead: "Current Value",
                              rSubHead:
                            ...
                            rpRow(
                                lhead: "XIRR",
                                lSubHead: "${sip.xirr}%",
                                rhead: "Last Tran Date",
                                rSubHead: "${sip.lastTranDate}"),
                            DottedLine(verticalPadding: 8),
                            ColumnText(
                              title: "Branch",
...
class BounceSipPojo {
  ...
  BounceSipPojo.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    pan = json['pan'];
    email = json['email'];
    mobile = json['mobile'];
