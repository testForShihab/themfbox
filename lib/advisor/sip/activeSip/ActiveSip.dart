...
class ActiveSip extends StatefulWidget {
  ActiveSip({
    super.key,
  ...
  @override
  State<ActiveSip> createState() => _ActiveSipState();
}

class _ActiveSipState extends State<ActiveSip> {
  ...
  Future getInitialInvestors() async {
    ...
    Map data = await AdminApi.getActiveSipDetails(
      user_id: user_id,
      client_name: client_name,
      sip_date: "",
      amc_name: selectedAMC.join(","),
      start_date: (start_date != null) ? formatDate(start_date!) : "",
      end_date: (end_date != null) ? formatDate(end_date!) : "",
        ...
        child: (isLoading)
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  ActiveSipPojo sip = ActiveSipPojo.fromJson(data);
  ...
  Widget sipTile(ActiveSipPojo sip) {
    String name = sip.schemeAmfiShortName ?? "";
    if (name.isEmpty) name = sip.schemeName ?? "";
  ...
  sipBottomSheet(ActiveSipPojo sip) {
...
class ActiveSipPojo {
  ...
  ActiveSipPojo.fromJson(Map<String, dynamic> json) {
