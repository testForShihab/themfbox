...
class MissingSip extends StatefulWidget {
  const MissingSip({
    super.key,
  ...
  @override
  State<MissingSip> createState() => _MissingSipState();
}

class _MissingSipState extends State<MissingSip> {
  ...
  Future getInitialInvestors() async {
    ...
    Map data = await AdminApi.getSipMissingReportDetails(
      user_id: user_id,
        ...
        child: (isLoading)
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  MissingSipPojo sip = MissingSipPojo.fromJson(data);
  ...
  Widget sipTile(MissingSipPojo sip) {
    String name = sip.schemeAmfiShortName ?? "";
    if (name.isEmpty) name = sip.scheme ?? "null";
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: ColumnText(
                    title: Utils.getFirst13(sip.name, count: 20),
                ...
                ColumnText(
                    ...
                    value: "${sip.startDay} ${sip.frequency}",
  ...
  sipBottomSheet(MissingSipPojo sip) {

    DateTime? lastTranDate = DateTime.tryParse(sip.lastTranDate!);
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ColumnText(
                                  title: Utils.getFirst13(sip.name, count: 17),
                                  value: "Folio: ${sip.folio}",
                                  alignment: CrossAxisAlignment.start,
                                  titleStyle: AppFonts.f50014Black,
                                  valueStyle: AppFonts.f40013,
                            ...
                            SizedBox(height: 8),
                            rpRow(
                              lhead: "Last Tran Date",
                              lSubHead: formatDate(lastTranDate!),
                              rhead: "",
                              rSubHead: "",
                            ),
                            SizedBox(height: 8),
...
class MissingSipPojo {
  ...
  MissingSipPojo.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    pan = json['pan'];
    email = json['email'];
    mobile = json['mobile'];
    ...
    investedCost = json['invested_cost'];
    currentValue = json['current_value'];
    xirr = json['xirr'];
    logo = json['logo'];
    lastTranDate = json['last_tran_date'];
