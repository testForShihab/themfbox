...
class ExpiringSip extends StatefulWidget {
  const ExpiringSip(
      {super.key,
  ...
  @override
  State<ExpiringSip> createState() => _ExpiringSipState();
}

class _ExpiringSipState extends State<ExpiringSip> {
  ...
  Future getInitialInvestors() async {
    ...
    Map data = await AdminApi.getSipExpiringShortlyDetails(
      user_id: user_id,
        ...
        child: (isLoading)
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  ExpiringSipPojo sip = ExpiringSipPojo.fromJson(data);
  ...
  Widget sipTile(ExpiringSipPojo sip) {
  ...
  sipBottomSheet(ExpiringSipPojo sip) {
...
class ExpiringSipPojo {
  ...
  ExpiringSipPojo.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    pan = json['pan'];
    email = json['email'];
    mobile = json['mobile'];
