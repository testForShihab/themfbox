...
class BranchWiseSip extends StatefulWidget {
  const BranchWiseSip({super.key});

  @override
  State<BranchWiseSip> createState() => _BranchWiseSipState();
}

class _BranchWiseSipState extends State<BranchWiseSip> {
  ...
  Future fetchChartData(String branch) async {
    EasyLoading.show();
                  ...
                  Padding(
                    ...
                    child: extraButton(
                      ...
                      onTap: () {
                        Get.back();
                        Get.to(
                            () => RmWiseSip(branch: branch, hasAppBar: true));
                      },
                    ),
                  ),
                  /*(showChart)
...
/*ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String displayValue = (title != "SIP Count" && title != "Abs Rtn" && title != "Share")
