...
class NonElssInvestors extends StatefulWidget {
  const NonElssInvestors({super.key});

  @override
  State<NonElssInvestors> createState() => _NonElssInvestorsState();
}

class _NonElssInvestorsState extends State<NonElssInvestors> {
  ...
  Future getNonElssDetails() async {
    page_id = 1;
    ...
    Map data = await AdminApi.getNonElssDetails(
        page_id: page_id,
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          return Scaffold(
            ...
            appBar:
                adminAppBar(title: "Non ELSS Investors", bgColor: Colors.white),
            body: Column(
              children: [
                Container(
                  color: Colors.white,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        ...
                        child: RpListTile2(
                            ...
                            l1: data['inv_name'],
                            l2: data['inv_pan'],
                            r1: Utils.formatNumber(data['aum_amount'],
                                isAmount: true),
                            r2: ""),
                      );
                    },
  ...
  showUserDetails(NonSIPInvestorsPojo userData) {
    String aum = Utils.formatNumber(userData.aumAmount, isAmount: true);
    num type_id = userData.typeId ?? 0;
    String name = userData.invName ?? "null";
    String invType = "null";
    ...
    if(client_name == 'nextfreedom'){
      rmname = userData.invSubBrokerName;
      subBrokerName = userData.invRmName;
    }else{
      rmname = userData.invRmName;
      subBrokerName = userData.invSubBrokerName;
    }
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  ListTile(
                    leading: InitialCard(title: userData.invName![0]),
                    title: Row(
                      children: [
                        Expanded(
                          child: Text("${userData.invName}",
                              maxLines: 3,
                              style: AppFonts.f50014Black,
                              softWrap: true),
                        ),
                        Text(
                          "$rupee ${Utils.formatNumber(userData.aumAmount)}",
                          style: AppFonts.f50014Black,
                        ),
                      ],
                    ),
                  ...
                  infoRow(
                      lHead: "PAN",
                      lSubHead: "${userData.invPan}",
                      rHead: "Mobile",
                      rSubHead: "${userData.invMobile}",
                      rStyle: AppFonts.f50014Theme
                          .copyWith(decoration: TextDecoration.underline)),
                  infoRow(
                      lHead: "Email",
                      lSubHead: "${userData.invEmail}",
                  ...
                  Divider(),
                  infoRow(lHead: "Branch", lSubHead: "${userData.invBranch}"),
                  infoRow(
                      lHead: "RM",
                      lSubHead: "$rmname",
