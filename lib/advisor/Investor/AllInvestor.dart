...
class _AllInvestorState extends State<AllInvestor> {
                            ...
                            child: InkWell(
                              onTap: () async {
                                if (userData.aum != 0) {
                                  ...
                                  await getMutualFundPortfolio(investor_id!);
                                  numberController =
  ...
  Future<void> whatsappshare(
      AllInvestorsPojo userData, MfSummaryPojo mfSummary, String mobile) {
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          TextButton(
                            onPressed: () {
                              _sendMessage(
                                  userData.mobile!, mfSummary, userData);
                              Get.back();
                            },
                            child: Text('Send',
                                style: AppFonts.f40016.copyWith(
  ...
  Future<void> _sendMessage(String phoneNumber, MfSummaryPojo mfSummary,
      AllInvestorsPojo userData) async {
