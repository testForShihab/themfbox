...
class _BlogDetailsState extends State<BlogDetails> {
  ...
  Future getArticlesDetails() async {
    ...
    Map<String, dynamic> data = await AdminApi.getArticlesDetails(
        article_id: id, client_name: client_name, user_id: user_id);
    if (data['status'] != 200) {
      Utils.showError(context, data['msg']);
      return -1;
    }
    htmlStrings = data['article']['content'];
    EasyLoading.dismiss();
  }
