...
import 'package:mymfbox2_0/advisor/stp/ActiveStp.dart';
import 'package:mymfbox2_0/advisor/stp/ClosedStp.dart';
...
class ActiveStpHome extends StatefulWidget {
  const ActiveStpHome({super.key, this.defaultSelection = "Active STPs"});
  final String defaultSelection;

  @override
  State<ActiveStpHome> createState() => _ActiveStpHomeState();
}

class _ActiveStpHomeState extends State<ActiveStpHome> {
