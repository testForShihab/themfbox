...
class StpPaymentSuccess extends StatefulWidget {
  const StpPaymentSuccess(
      {super.key, required this.paymentId, this.msg = ""});
  final String paymentId;
  final String msg;
  @override
  State<StpPaymentSuccess> createState() => _StpPaymentSuccessState();
}

class _StpPaymentSuccessState extends State<StpPaymentSuccess> {
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 10),
                                Text(
                                  "1. STP order placed Successfully.",
