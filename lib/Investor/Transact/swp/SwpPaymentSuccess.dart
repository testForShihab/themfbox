...
class SwpPaymentSuccess extends StatefulWidget {
  const SwpPaymentSuccess(
      {super.key, required this.paymentId, this.msg = ""});
  final String paymentId;
  final String msg;
  @override
  State<SwpPaymentSuccess> createState() => _SwpPaymentSuccessState();
}

class _SwpPaymentSuccessState extends State<SwpPaymentSuccess> {
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 10),
                                Text(
                                  "1. SWP order placed Successfully.",
