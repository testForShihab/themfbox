...
class ProofOfIdentity2 extends StatelessWidget {
  const ProofOfIdentity2({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List points = [
      ...
      "4. Your PAN details fetched from DigiLocker will be auto filled, which you need to verify and continue further.",
    ];
        ...
        child: Column(
          children: [
            ...
            RpFilledButton(
                onPressed: () async {
                  EasyLoading.show();
                  Map data = await EkycApi.getDigiLockerPanUrl(
                    user_id: user_id,
                  ...
                  EasyLoading.dismiss();
                  String url = data['url'];
                  Get.to(() => GoToDigiLocker(url: url, type: "PAN"));
                },
