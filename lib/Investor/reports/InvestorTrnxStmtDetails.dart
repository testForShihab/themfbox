...
class InvestorTrnxStmtDetails extends StatefulWidget {
  const InvestorTrnxStmtDetails({super.key, required this.schemeItem});

  final Map schemeItem;

  @override
  State<InvestorTrnxStmtDetails> createState() =>
      _InvestorTransactionStatementState();
}

class _InvestorTransactionStatementState
    extends State<InvestorTrnxStmtDetails> {
  Map schemeItem = {};
  ...
  Widget displayPage() {
    ...
    num purchaseCost = schemeItem['currentCostOfInvestment'] ?? 0.0;
    ...
    String navDate = schemeItem['latestNavDate_str'];
    String date = navDate.substring(0, 10);
    num latestNav = schemeItem['latestNav'];
    String scheme_logo = schemeItem['amc_logo'];
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ColumnText(
                            ...
                            value:
                                "$rupee ${Utils.formatNumber(purchaseCost.round())}",
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ColumnText(
                            ...
                            titleStyle: AppFonts.f40013
                                .copyWith(color: Config.appTheme.overlay85),
                            value: "${Utils.formatNumber(balanceUnits)} ",
                            valueStyle: AppFonts.f50014Black
                                .copyWith(color: Colors.white),
  ...
  Widget transactionCard(Map data) {
    ...
    DateTime originalDate = DateFormat('dd-MM-yyyy').parse(dateString);
    String formattedTranxDate = DateFormat('dd MMM yyyy').format(originalDate);
