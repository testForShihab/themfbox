...
class StpSysTrnx extends StatefulWidget {
  const StpSysTrnx({super.key});

  @override
  State<StpSysTrnx> createState() => _StpSysTrnxState();
}

class _StpSysTrnxState extends State<StpSysTrnx> {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (overAllList.isEmpty)
          return NoSchemes(img: "assets/stp_cancellation.png", name: "STP");
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return SizedBox(
          ...
          child: Column(
            children: [
              BottomSheetTitle(title: "STP Actions"),
              Padding(
                padding: EdgeInsets.fromLTRB(16, 16, 16, 0),
              ...
              InkWell(
                  ...
                  child: actionBtn(icon: Icons.pause_circle_outline, label: "Pause STP")),
              InkWell(
                onTap: (){
                  //controller.cancelBottomSheet( client_code_map, scheme);
                },
                child: actionBtn(
                    icon: Icons.delete_forever_outlined, label: "Cancel STP"),
              ),
            ],
          ),
        );
