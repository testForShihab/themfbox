...
class _BanksandMandatesState extends State<BanksandMandates> {
    ...
    Map data = await TransactionApi.generateBankMandate(
        ...
        mandate_option: (client_code_map['bse_nse_mfu_flag'] == "BSE")
            ...
            : (client_code_map['bse_nse_mfu_flag'] == "NSE" &&
                ...
                : paymentModecode,
        // mandate_option:
        //     (client_code_map['bse_nse_mfu_flag'] == "MFU") ? paymentMode : "",
        // mandate_type: (client_code_map['bse_nse_mfu_flag'] == "BSE")
        //     ? "EMANDATE"
        //     : mandatecode,
  ...
  void initState() {
    super.initState();
    // Show the alert dialog after the widget is built
...
//****$mask
  ...
  DateTime endDate = DateTime(
      DateTime.now().year + 40, DateTime.now().month, DateTime.now().day);
                      ...
                      child: Column(
                        children: [
                          ...
                          if (showAdditionalFields) ...[
                            ...
                            mandateTypeTile(context, bottomSheet),
                            SizedBox(
                              height: 10,
                            ),
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          subtitle: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(mandateType.isEmpty ? 'Select Type' : mandateType,
                  style: AppFonts.f50012),
            ],
          ),
          children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          //RupeeCard(title: "Mandate Amount", minAmount: minAmount, hintTitle: 'Enter Mandate Amount'),
          SizedBox(
            height: 10,
          ),
          /*Container(
