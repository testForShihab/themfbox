...
class MandateSuccess extends StatefulWidget {
   MandateSuccess({super.key,required this.deleteMessage,required this. bankaccName,required this. number,required this. ifscCode,required this.pagename,this.mandateAmount = 0});
